...
void CheckDuplicates(TString tracfile = "data/523306/o2trac_its.root", TString output = ".", TString rootSave = "", int rofStart = 0, int rofEnd = -1, int windowSize = 2, bool includeSame = 1)
{
